...
Stepper stepper(10, 27, 26, 25, 33);
int previous = 0;
...
void loop() {
  ...
  */
 const int numPixel = strip.numPixels();
 /*
  for (int i = 0; i < numPixel - 3; ++i)
  {
  ...
  for (int i = numPixel - 3; i < numPixel; ++i)
  {
  ...
  strip.setPixelColor(1, strip.Color(0,30,0));
  strip.setPixelColor(2, strip.Color(0,30,0));
  strip.setPixelColor(3, strip.Color(0,30,0));
  strip.setPixelColor(4, strip.Color(0,30,0));
  strip.setPixelColor(5, strip.Color(0,30,0));
